...
from autosub import featureExtraction as FE
from autosub import trainAudio as TA
...
def silenceRemoval(input_file, num, smoothing_window = 1.0, weight = 0.2):
    ...
    for i, s in enumerate(segmentLimits):
        strOut = "{0:s}_{1:.3f}-{2:.3f}.wav".format(input_file, s[0] + num*540, s[1] + num*540)
        print(strOut, "              ", input_file[0:-4], s[0], s[1])
